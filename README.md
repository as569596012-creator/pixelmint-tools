# PicCrush — 免费在线图片工具站（靠海外搜索流量赚钱）

一个用 **Next.js 静态导出** 做的「免费工具站」起步项目：4 个纯浏览器端图片工具（压缩 / HEIC→JPG / PNG→JPG / 图片转 WebP），主打**隐私(不上传)+ 免费 + 无水印**，靠 Google 长尾搜索流量 + 展示广告(AdSense/Ezoic)变现。域名：piccrush.com
